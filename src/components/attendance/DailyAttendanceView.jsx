            ...
            <tbody className="divide-y divide-gray-100">
              {filtered.map((emp, index) => (
                ...
                >
                  <td className="px-6 py-4">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-slate-400 font-semibold">{emp.uid}</p>
                      </div>
                    </div>
                  </td>
                  <td className="px-6 py-4">
                  ...
                  <td className="px-6 py-4">
                    <span className="text-xs font-bold text-slate-800">{emp.workingHours ? `${emp.workingHours}h` : '0h'}</span>
                  </td>
                  <td className="px-6 py-4">
